...
!varibale definition
integer(int_kind):: bit_len = 16
common bit_len

integer(int_kind),allocatable :: array(:)

integer(int_kind) :: r

integer(int_kind) :: test_num = 10
...
!  array = trans_binary(my_id)

 ! write(*,'(16I1)') (array(r),r=1,bit_len)
